...
Please see the "figure_data+code" folder in this repo for data (simulated values) used for figures and the code for plotting the figures. The files in "large_data_files" are too large to be supported by the anonymized version of this repo. 
