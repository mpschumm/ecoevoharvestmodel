...
Please see the "smaller_files_figures_data_code" folder, and the "large_data_files" folder, in this repo for data (simulated values) used for figures and the code for plotting the figures. The files in "large_data_files" may be too large to be supported by the anonymized version of this repo. 
