...
**Scenario 1: No harvesting, constant resource**
...
plot(approach[seq(round(add_genotypes/timescale),length(approach), by=4)],lty=1, pch=19, type="l", ylab="Abundance",xlab="Time (3 months)", ylim=c(0,max(approach)), main= "No harvesting, constant resource")
approach <- vector(mode="numeric", length=runtime)
for (i in 1:runtime) {
